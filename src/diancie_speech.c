...
static const u16 sKabaSpeech_BgGfx[] = INCBIN_U16("graphics/diancie_speech/bg.4bpp");
static const u16 sKabaSpeech_BgPal[] = INCBIN_U16("graphics/diancie_speech/bg.gbapal");
static const u32 sKabaSpeech_BgMap[] = INCBIN_U32("graphics/diancie_speech/bg.bin.lz");

static const u16 sKabaSpeech_KabaPicGfx[] = INCBIN_U16("graphics/diancie_speech/pics/kaba.4bpp");
static const u16 sKabaSpeech_KabaPicPal[] = INCBIN_U16("graphics/diancie_speech/pics/kaba.gbapal");
static const u32 sKabaSpeech_KabaPicMap[] = INCBIN_U32("graphics/diancie_speech/pics/kaba.bin.lz");

//! NOTE: both aka and ao has the same palette as of writing
static const u16 sKabaSpeech_PlayerPicPal[] = INCBIN_U16("graphics/diancie_speech/pics/ao.gbapal");

static const u16 sKabaSpeech_AkaPicGfx[] = INCBIN_U16("graphics/diancie_speech/pics/aka.4bpp");
static const u8 sKabaSpeech_AkaPicMap[] = INCBIN_U8("graphics/diancie_speech/pics/aka.bin");

static const u16 sKabaSpeech_AoPicGfx[] = INCBIN_U16("graphics/diancie_speech/pics/ao.4bpp");
static const u8 sKabaSpeech_AoPicMap[] = INCBIN_U8("graphics/diancie_speech/pics/ao.bin");

static const u16 sKabaSpeech_PlatformGfx[] = INCBIN_U16("graphics/diancie_speech/platform.4bpp");
static const u16 sKabaSpeech_PlatformPal[] = INCBIN_U16("graphics/diancie_speech/platform.gbapal");
...
{
    DebugPrintf("sKabaSpeech->timer:%u", sKabaSpeech->timer);
    u32 spriteId;
    if (!IsTextPrinterActive(WIN_TEXT))
    {
        if (sKabaSpeech->timer)
