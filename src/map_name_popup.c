...
{
    [MAPSEC_FLOTT_TOWN] = MAPPOPUP_THEME_WOOD,
    [MAPSEC_DOCKSIDE_CITY] = MAPPOPUP_THEME_MARBLE,
    [MAPSEC_OASIS_TOWN] = MAPPOPUP_THEME_WOOD,
...
{
    [MAPSEC_FLOTT_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_DOCKSIDE_CITY] = MAPPOPUP_THEME_BW_DEFAULT,
    [MAPSEC_OASIS_TOWN] = MAPPOPUP_THEME_BW_DEFAULT,
