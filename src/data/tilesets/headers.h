...
const struct Tileset gTileset_PrimaryTutorial =
{
    .isCompressed = TRUE,
    .isSecondary = FALSE,
    .tiles = gTilesetTiles_PrimaryTutorial,
    .palettes = gTilesetPalettes_PrimaryTutorial,
    .metatiles = gMetatiles_PrimaryTutorial,
    .metatileAttributes = gMetatileAttributes_PrimaryTutorial,
    .callback = NULL,
};

const struct Tileset gTileset_SecondaryTutorial =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_SecondaryTutorial,
    .palettes = gTilesetPalettes_SecondaryTutorial,
    .metatiles = gMetatiles_SecondaryTutorial,
    .metatileAttributes = gMetatileAttributes_SecondaryTutorial,
    .callback = NULL,
};

const struct Tileset gTileset_OasisTown =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_OasisTown,
...
const struct Tileset gTileset_Recompiled_Pokemon_Center =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_Recompiled_Pokemon_Center,
    .palettes = gTilesetPalettes_Recompiled_Pokemon_Center,
    .metatiles = gMetatiles_Recompiled_Pokemon_Center,
...
const struct Tileset gTileset_OasisTown_Indoors =
{
    .isCompressed = TRUE,
    .isSecondary = TRUE,
    .tiles = gTilesetTiles_OasisTown_Indoors,
    .palettes = gTilesetPalettes_OasisTown_Indoors,
    .metatiles = gMetatiles_OasisTown_Indoors,
    .metatileAttributes = gMetatileAttributes_OasisTown_Indoors,
    .callback = NULL,
};
