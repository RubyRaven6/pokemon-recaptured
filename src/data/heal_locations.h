...
{
    [HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F - 1] = {MAP_GROUP(FLOTT_TOWN_PLAYER_HOUSE_2F), MAP_NUM(FLOTT_TOWN_PLAYER_HOUSE_2F), 5, 4},
    [HEAL_LOCATION_DOCKSIDE_CITY - 1] = {MAP_GROUP(DOCKSIDE_CITY), MAP_NUM(DOCKSIDE_CITY), 30, 23},
    ...
    [HEAL_LOCATION_PORYTILES_TUTORIAL_PRIMARY - 1] = {MAP_GROUP(PORYTILES_TUTORIAL_PRIMARY), MAP_NUM(PORYTILES_TUTORIAL_PRIMARY), 10, 10},
    [HEAL_LOCATION_OASIS_TOWN - 1] = {MAP_GROUP(OASIS_TOWN), MAP_NUM(OASIS_TOWN), 10, 10},
};
