...
{
    [HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F - 1] =
    {
        .group = MAP_GROUP(FLOTT_TOWN_PLAYER_HOUSE_2F),
        .map = MAP_NUM(FLOTT_TOWN_PLAYER_HOUSE_2F),
        .x = 2,
        .y = 7,
    },
    ...
    [HEAL_LOCATION_DOCKSIDE_CITY - 1] =
    {
        .group = MAP_GROUP(DOCKSIDE_CITY_POKEMON_CENTER),
        .map = MAP_NUM(DOCKSIDE_CITY_POKEMON_CENTER),
        DEFAULT_POKEMON_CENTER_COORDS,
    },
...
{
    [HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F - 1] = 1,
    [HEAL_LOCATION_DOCKSIDE_CITY - 1] = 1,
