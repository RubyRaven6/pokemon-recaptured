...
{
    [MAPSEC_FLOTT_TOWN] = {MAP_GROUP(FLOTT_TOWN), MAP_NUM(FLOTT_TOWN), HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F},
    [MAPSEC_DOCKSIDE_CITY] = {MAP_GROUP(DOCKSIDE_CITY), MAP_NUM(DOCKSIDE_CITY), HEAL_LOCATION_DOCKSIDE_CITY},
    [MAPSEC_OASIS_TOWN] = {MAP_GROUP(OASIS_TOWN), MAP_NUM(OASIS_TOWN), HEAL_LOCATION_OASIS_TOWN},
    ...
    [MAPSEC_ROUTE_1] = {MAP_GROUP(ROUTE101), MAP_NUM(ROUTE101), HEAL_LOCATION_NONE},
...
static u8 GetMapsecType(u16 mapSecId)
{
    ...
    case MAPSEC_FLOTT_TOWN:
        return FlagGet(FLAG_VISITED_FLOTT_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_DOCKSIDE_CITY:
        return FlagGet(FLAG_VISITED_DOCKSIDE_CITY) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
    case MAPSEC_OASIS_TOWN:
        return FlagGet(FLAG_VISITED_OASIS_TOWN) ? MAPSECTYPE_CITY_CANFLY : MAPSECTYPE_CITY_CANTFLY;
...
static void CreateFlyDestIcons(void)
{
    ...
    canFlyFlag = FLAG_VISITED_FLOTT_TOWN;
    for (mapSecId = MAPSEC_FLOTT_TOWN; mapSecId <= MAPSEC_EVER_GRANDE_CITY; mapSecId++)
    {
        ...
        if (!UpdatePaletteFade())
        {
            ...
            if (sFlyMap->choseFlyLocation)
            {
                ...
                case MAPSEC_BATTLE_FRONTIER:
                    ...
                    break;
                case MAPSEC_FLOTT_TOWN:
                    SetWarpDestinationToHealLocation(gSaveBlock2Ptr->playerGender == MALE ? HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F : HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F);
                    break;
                case MAPSEC_EVER_GRANDE_CITY:
