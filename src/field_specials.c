...
{
    u8 i;
    u16 starter = GetStarterPokemon(VarGet(VAR_UNUSED_0x4023));
...
bool8 UsedPokemonCenterWarp(void)
{
    ...
    {
        //MAP_DOCKSIDE_CITY_POKEMON_CENTER_1F,
...
u32 GetMartEmployeeObjectEventId(void)
{
    ...
    {
        //{ MAP_GROUP(DOCKSIDE_CITY_MART),     MAP_NUM(DOCKSIDE_CITY_MART),     LOCALID_OLDALE_MART_CLERK },
