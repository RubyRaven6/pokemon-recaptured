...
#define FLAG_DEFEATED_OASIS_GYM                                     0x4F0
...
// Towns and Cities
#define FLAG_VISITED_FLOTT_TOWN                     (SYSTEM_FLAGS + 0xF)
#define FLAG_VISITED_DOCKSIDE_CITY                  (SYSTEM_FLAGS + 0x10)
#define FLAG_VISITED_OASIS_TOWN                     (SYSTEM_FLAGS + 0x11)
