...
#define HEAL_LOCATION_FLOTT_TOWN_PLAYER_HOUSE_2F 1
#define HEAL_LOCATION_DOCKSIDE_CITY 2
...
#define HEAL_LOCATION_PORYTILES_TUTORIAL_PRIMARY 12
#define HEAL_LOCATION_OASIS_TOWN 13
