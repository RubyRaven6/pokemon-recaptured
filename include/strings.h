...
extern const u8 gText_Diancie_CanYouHearMe[];
...
//Masculine Names
extern const u8 gText_DefaultNameDuane[];
// extern const u8 gText_DefaultNameMason[];
// extern const u8 gText_DefaultNameCole[];
// extern const u8 gText_DefaultNameJet[];
// extern const u8 gText_DefaultNameFlint[];
// extern const u8 gText_DefaultNameAlexandrite[];
//Feminine Names
extern const u8 gText_DefaultNameDiane[];
// extern const u8 gText_DefaultNameJewel[];
// extern const u8 gText_DefaultNameCrystal[];
// extern const u8 gText_DefaultNameJade[];
// extern const u8 gText_DefaultNameStella[];
// extern const u8 gText_DefaultNameOpal[];
...
extern const u8 gText_SideQuestMap2[]; // Default. Needed for things not to break.
