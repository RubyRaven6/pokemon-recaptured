...
// Eg: If FALSE is set to FALSE, all members of the Sneasel Family will be disabled
...
#define P_FAMILY_TEDDIURSA               P_GEN_1_POKEMON
...
#define P_FAMILY_TINKATINK               P_GEN_1_POKEMON
